...
function showResults(){
  ...
  try {
    localStorage.setItem('a4p_pmp_profile', mentalProfile);
    localStorage.setItem('a4p_pmp_mbti', scores.mbtiType);
    localStorage.setItem('a4p_pmp_action_code', scores.actionCode);
    localStorage.setItem('a4p_pmp_scores', JSON.stringify(scores.pmp));
    localStorage.setItem('a4p_pmp_completed', 'true');
    localStorage.setItem('a4p_identity_name', m.name || '');
    localStorage.setItem('a4p_identity_sport', m.sport || '');
    localStorage.setItem('a4p_identity_age', m.age || '');
    localStorage.setItem('a4p_identity_club', m.club || '');
  } catch(e) {}
...
function restart(){if(!confirm('Recommencer le test ? Les réponses seront effacées.'))return;answers={};currentIndex=0;localStorage.removeItem('a4p_pmp_mbti_actiontypes_final');localStorage.removeItem('a4p_pmp_profile');localStorage.removeItem('a4p_pmp_mbti');localStorage.removeItem('a4p_pmp_action_code');localStorage.removeItem('a4p_pmp_scores');localStorage.removeItem('a4p_pmp_completed');els.resultsCard.classList.add('hidden');els.metaCard.classList.remove('hidden');els.testCard.classList.remove('hidden');renderQuestion();}
init();
